...
class ArchiveReportReason(str, PyEnum):
    ...
    FILE_QUALITY_OR_CONTENT = "file_quality_or_content"
    METADATA_INCORRECT = "metadata_incorrect"
    ANSWER_OR_ATTACHMENT_MISMATCH = "answer_or_attachment_mismatch"
    DUPLICATE_OR_MISPLACED = "duplicate_or_misplaced"
    PRIVACY_INFORMATION = "privacy_information"
    INAPPROPRIATE_COPYRIGHT_OR_OTHER_CONCERN = (
        "inappropriate_copyright_or_other_concern"
    )
    OTHER = "other"
