...
PREVIOUS_PREVIOUS_HEAD = "e2c6a8f4b1d9"
...
def test_revision_is_the_sole_forward_head() -> None:
    ...
    assert script.get_revision(PREVIOUS_HEAD).down_revision == PREVIOUS_PREVIOUS_HEAD
    assert script.get_revision(PREVIOUS_PREVIOUS_HEAD).down_revision == NEXT_REVISION
