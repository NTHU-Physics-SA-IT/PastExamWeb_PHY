...
| `AboutUsEntry` | Independent persisted Markdown title/body entries with an optional last-editor reference | Authenticated-readable managed information; multiple entries are retained and ordered by latest update | Confirmed by code and focused API tests |
