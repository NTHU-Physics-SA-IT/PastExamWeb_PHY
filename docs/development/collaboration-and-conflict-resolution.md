...
4. Before using coordination, resolve its exact name with
   ...
   Resolution also requires the protected lifecycle, active integration
   ruleset, exact branch-local identity, and current-main ancestry; a visible
   ref alone cannot authorize coordination. Follow the
   [protected coordination runbook](../runbooks/coordination.md).
