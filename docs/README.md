...
| [`runbooks/production-framework-maintenance.md`](runbooks/production-framework-maintenance.md) | Production framework-maintenance bootstrap, installation, integrity, and revocation | Active | Separate install-only lane; never application deployment or migration authority. |
