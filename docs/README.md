...
| [`runbooks/trusted-activation.md`](runbooks/trusted-activation.md) | Trusted Activation App, settings, lifecycle, and recovery procedure | Active | Operational authority for ADR-0012; does not authorize product, production, or database changes. |
