...
| [`runbooks/trusted-activation.md`](runbooks/trusted-activation.md) | Trusted Activation App, settings, lifecycle, and recovery procedure | Active | Operational authority for ADR-0011; does not authorize product, production, or database changes. |
