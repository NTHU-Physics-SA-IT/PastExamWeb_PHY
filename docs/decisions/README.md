...
| [ADR-0010](0010-retain-full-fallback-for-governance-sensitive-ordinary-product-postmerge.md) | Retain Full Fallback for Governance-Sensitive Ordinary-Product Coordination Postmerge | Accepted | Governance-sensitive ordinary-product coordination postmerge evidence reuse and Full fallback |
| [ADR-0011](0011-trusted-activation-for-protected-coordination.md) | Trusted Activation for Protected Coordination | Accepted | Independent-App activation, protected coordination lifecycle, revocation, return, and retirement |
