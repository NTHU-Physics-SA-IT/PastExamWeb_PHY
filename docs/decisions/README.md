...
| [ADR-0012](0012-trusted-ruleset-visibility-permission-boundary.md) | Trusted Ruleset Visibility Permission Boundary | Accepted | Administration-write visibility with GET-only token and client separation |
